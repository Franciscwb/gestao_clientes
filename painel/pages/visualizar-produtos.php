...
<div class="box-content">
    <h2><i class="fa fa-id-card-o" aria-hidden="true"></i><b> Produtos no Estoque</b> </h2>
    <div class="busca">
        <h4><i class="fa fa-search"> Realizar uma busca</i></h4>
        <form method="post">
    ...
    <?php
        ...
        $sql->execute();
        if($sql->rowCount() > 0){
        Painel::alert('atencao','Você está com produtos em falta <a href="'.INCLUDE_PATH_PAINEL.'visualizar-produtos?pendentes">aqui</a> para visualiza-los!');
        }
    ...
    <div class="boxes">
        <?php
            ...
            $imagemSingle = $imagemSingle->fetch()['imagens'];
        ?>
        <div class="box-single-wrapper">
            ...
            <div style="width: 70%;float: left;border: 0;" class="box-single">
                <div class="body-box">
                    ...
                    <p><b><i class="fa fa-pencil"></i> Largura do Produto:</b> <?php echo $value['largura'] ?>cm</p>
                    <p><b><i class="fa fa-pencil"></i> Altura do Produto:</b> <?php echo $value['altura'] ?>cm</p>
                    <p><b><i class="fa fa-pencil"></i> Comprimento do Produto:</b> <?php echo $value['comprimento'] ?>cm</p>
                    <div style="padding: 8px 0; border-bottom: 1px solid #ccc" class="group-btn">
                        <form method="post" style="margin: 0;">
                            ...
                            <input style="background: #52658F;" type="submit" name="atualizar" value="Atualizar!">
                        </form>
                    </div><!--group-btn-->
                    <div class="group-btn">
